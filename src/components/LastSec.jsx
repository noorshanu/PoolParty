...
function LastSec() {
  return (
<>
<section className="relative card bg-white/70 rounded-20 mt-4 pb-2 sm:pb-10" style="translate: none; rotate: none; scale: none; opacity: 1; transform: translate(0px, 0px);">
         ...
         <div className="listed p-2 sm:p-4 flex flex-col gap-1 max-h-[500px] overflow-auto">
            <div className="row flex items-center justify-between bg-white rounded-xl min-h-10 border border-row-border">
               ...
               <div className="col flex flex-col-reverse sm:flex-row sm:items-center text-sm sm:text-base py-1 px-2 sm:p-0">
                  ...
                  <div className="score text-xs min-w-[50px] text-right opacity-70 font-medium mt-2 sm:mt-0 mr-12 sm:mr-3"><img alt="achievement" loading="lazy" width="20" height="20" decoding="async" data-nimg="1" className="ml-auto aspect-square" src="/icons/achievement1.svg" style="color: transparent;"></div>
               </div>
            </div>
            <div className="row flex items-center justify-between bg-white rounded-xl min-h-10 border border-row-border">
               <div className="col flex items-center gap-2 ml-2 ">
               ...
               <div className="col flex flex-col-reverse sm:flex-row sm:items-center text-sm sm:text-base py-1 px-2 sm:p-0">
                  ...
                  <div className="score text-xs min-w-[50px] text-right opacity-70 font-medium mt-2 sm:mt-0 mr-12 sm:mr-3"><img alt="achievement" loading="lazy" width="20" height="20" decoding="async" data-nimg="1" className="ml-auto aspect-square" src="/icons/achievement2.svg" style="color: transparent;"></div>
               </div>
            </div>
            <div className="row flex items-center justify-between bg-white rounded-xl min-h-10 border border-row-border">
               <div className="col flex items-center gap-2 ml-2 ">
               ...
               <div className="col flex flex-col-reverse sm:flex-row sm:items-center text-sm sm:text-base py-1 px-2 sm:p-0">
                  ...
                  <div className="score text-xs min-w-[50px] text-right opacity-70 font-medium mt-2 sm:mt-0 mr-12 sm:mr-3"><img alt="achievement" loading="lazy" width="20" height="20" decoding="async" data-nimg="1" className="ml-auto aspect-square" src="/icons/achievement3.svg" style="color: transparent;"></div>
               </div>
            </div>
            <div className="row flex items-center justify-between bg-white rounded-xl min-h-10 border border-row-border">
               <div className="col flex items-center gap-2 ml-2 ">
